...
const ConditionsUtilisation = () => {
  const termsSchema = {
    ...
    "url": "https://campagnesms.com/conditions-d-utilisation",
    "mainContentOfPage": {
      "@type": "WebPageElement",
      "about": {
        "@type": "Thing",
  ...
  return (
    <>
      <SEOMetadata
        ...
        canonicalUrl="https://campagnesms.com/conditions-d-utilisation"
      />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="prose max-w-none prose-headings:text-gray-900 prose-headings:dark:text-white prose-p:text-gray-700 prose-p:dark:text-gray-300 prose-strong:text-gray-900 prose-strong:dark:text-white prose-li:text-gray-700 prose-li:dark:text-gray-300">
              ...
              <p>Notre traitement des données personnelles est régi par notre <a href="/politique-de-confidentialite" className="text-primary hover:underline">Politique de confidentialité</a>. En utilisant notre service, vous consentez à la collecte, au traitement et au stockage de vos données comme décrit dans cette politique.</p>
